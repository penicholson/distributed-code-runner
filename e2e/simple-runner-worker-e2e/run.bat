...
call mvn clean install -DargLine="-Ddcr.e2e.kafka.bootstrap.urls=192.168.99.100:9092 -Ddcr.e2e.configurationservice.url=http://192.168.99.100:8080" -pl pl.petergood.dcr:simple-runner-worker-e2e
